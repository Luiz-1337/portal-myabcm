...
const Login = () => {
 ...
 <div className='w-full h-screen md:flex items-start'>
    <div className='relative w-2/3 h-full flex flex-col'>
      ...
      <img src='https://cdn.eadplataforma.app/client/myabcm/upload/crop/others/f625aec40ff01c8adbfafa8b50d6c031.png-login-cover.png' className='w-full h-full object-cover'/>
    </div> 

    <div className='w-1/3 h-full bg-[#f5f5f5] flex flex-col p-20 justify-between items-center'>
      <img src='https://cdn.eadplataforma.app/client/myabcm/upload/others/753689c9b3db9008b0296c49aadc0ad9.png'/>
      ...
      <div className='w-full flex flex-col'>
        <button className='w-full text-white my-2 font-semibold bg-[#14335C] hover:bg-[#14335C]/70 rounded-md p-4 text-center flex intems-center justify-center cursor-pointer'>
        Log in
        </button>
        <button className='w-full text-[#14335C] my-2 bg-white border hover:bg-[#14335C]/10 border-black/40 rounded-md p-4 text-center flex intems-center justify-center cursor-pointer'>
        Register
        </button>
      </div>
      ...
      <p className='text-sm font-normal text-[#14335C]'>Don't have a account ? <span className='font-semibold underline underline-offset-2 cursor-pointer' to='https://forms.office.com/Pages/ResponsePage.aspx?id=8Cpd8_38tkOX4MpDvuttySoNTdTv6wtOsNUoCOTLFEFURjJNRVRJQkw4NkpXRlA1QVROR0owN01ZVi4u'>Create profile</span></p>  
      </div> 
